...
import mod.hitlerhax.event.HtlrEventConnection;
...
public class Module implements Listenable {
	...
	protected final HtlrInventory inv = new HtlrInventory();
	...
	public boolean onPacket(Object packet, HtlrEventConnection.Side side) {
		return true;
	}
