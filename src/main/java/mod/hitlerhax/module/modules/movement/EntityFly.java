...
public class EntityFly extends Module {
	...
	ModeSetting mode = new ModeSetting("Mode", this, "y-axis motionless", "y-axis motionless", "fall reduction",
			"packet");
	FloatSetting multiplier = new FloatSetting("Multiplier", this, 1.0f);
	FloatSetting glideHeight = new FloatSetting("Glide Height", this, 0.3f);
	FloatSetting vSpeed = new FloatSetting("Packet VSpeed", this, 1.0f);
	FloatSetting hSpeed = new FloatSetting("Packet HSpeed", this, 1.0f);
	FloatSetting reduction = new FloatSetting("Fall Reduction", this, 0.03f);
