...
public class HtlrSplashScreen extends GuiScreen {
	...
	public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
		if (HtlrSplashScreen.isHovered(this.x, this.y,
		...
		} else if (HtlrSplashScreen.isHovered(this.x, this.y + 22,
				Minecraft.getMinecraft().fontRenderer.getStringWidth("Multiplayer"),
				Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT, mouseX, mouseY)) {
			this.mc.displayGuiScreen(new GuiMultiplayer(this));
		} else if (HtlrSplashScreen.isHovered(this.x, this.y + 44,
				Minecraft.getMinecraft().fontRenderer.getStringWidth("Settings"),
				Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT, mouseX, mouseY)) {
			this.mc.displayGuiScreen(new GuiOptions(this, this.mc.gameSettings));
		} else if (HtlrSplashScreen.isHovered(this.x, this.y + 66,
